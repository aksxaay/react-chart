      ...
      <div className="absolute hidden w-64 flex-col justify-between bg-gray-800 shadow sm:relative sm:flex md:h-full">
        <div className="px-8">
          ...
          <ul className="mt-12">
            ...
            <li className="mb-6 flex w-full cursor-pointer items-center justify-between text-gray-600 hover:text-gray-500">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="flex w-full cursor-pointer items-center justify-between text-gray-600 hover:text-gray-500">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="mt-48 mb-4 flex w-full justify-center">
            <div className="relative ">
              ...
              <input
                className=" w-full rounded bg-gray-700 bg-gray-100 py-2 pl-10 text-sm text-gray-500 focus:outline-none"
                type="text"
                placeholder="Search"
              />
            </div>
